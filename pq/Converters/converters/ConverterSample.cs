...
namespace pq.MyConverters
{
    ...
    public class BorderBras : IValueConverter
    {
        ...
        public object Didvote(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            if ((bool)value)
                return (Brush)Application.Current.TryFindResource("Accent");
            else
                return (Brush)Application.Current.TryFindResource("ItemTextDisabled");
        }
