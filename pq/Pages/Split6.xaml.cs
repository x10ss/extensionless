...
namespace pq.Pages
{
    ...
    /// </summary>
    public partial class Split6 : UserControl, IContent
    {
        public SplitViewModel SVM = new SplitViewModel(5);
        public Split6()
        {
            InitializeComponent();
        ...
        void IContent.OnNavigatedTo(FirstFloor.ModernUI.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            SVM.Notify();
            //  throw new NotImplementedException();
            //  AppearanceManager.Current.AccentColor = Helper.Helper.GetAccent(11);
