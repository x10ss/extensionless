...
namespace pq.Pages
{
    ...
    /// </summary>
    public partial class Split4 : UserControl, IContent
    {
        public SplitViewModel SVM = new SplitViewModel(3);
        public Split4()
        {
            InitializeComponent();
        ...
        void IContent.OnNavigatedTo(FirstFloor.ModernUI.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            SVM.Notify();
            //  throw new NotImplementedException();
            //    AppearanceManager.Current.AccentColor = Helper.Helper.GetAccent(7);
