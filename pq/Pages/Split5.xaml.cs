...
namespace pq.Pages
{
    ...
    /// </summary>
    public partial class Split5 : UserControl, IContent
    {
        public SplitViewModel SVM = new SplitViewModel(4);
        public Split5()
        {
            InitializeComponent();
        ...
        void IContent.OnNavigatedTo(FirstFloor.ModernUI.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            SVM.Notify();
            //  throw new NotImplementedException();
            //    AppearanceManager.Current.AccentColor = Helper.Helper.GetAccent(9);
            fetulj.Focus();
