...
namespace pq.Pages
{
    ...
    /// </summary>
    public partial class Split3 : UserControl, IContent
    {
        public SplitViewModel SVM = new SplitViewModel(2);
        public Split3()
        {
            InitializeComponent();
        ...
        void IContent.OnNavigatedTo(FirstFloor.ModernUI.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            SVM.Notify();
            //  throw new NotImplementedException();
            //AppearanceManager.Current.AccentColor = Helper.Helper.GetAccent(5);
            fetulj.Focus();
